...
import gui.panels.AdminAccountsPanel;
import gui.panels.AdminUsersPanel;
import gui.panels.Refreshable;
import model.User;
...
public class AdminDashboard extends JPanel {
    ...
    public AdminDashboard(MainFrame frame, User adminUser) {
    ...
    private void promptAdvanceTime() {
        ...
        //Αν ο χρήστης πάτησε Cancel ή δεν έγραψε τίποτα
