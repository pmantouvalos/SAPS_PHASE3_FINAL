...
import service.observer.AccountObserver; // Import του Observer Interface
...
public class HomePanel extends JPanel implements Refreshable, AccountObserver {
    ...
    public HomePanel(model.entities.User user) {
        ...
        JLabel l1 = new JLabel("Με μια ματιά - Οι λογαριασμοί μου"); 
        l1.setFont(new Font("Segoe UI", Font.BOLD, 18));
        p1.add(l1, BorderLayout.NORTH);
        
        accModel = new DefaultTableModel(new String[]{"IBAN", "Τύπος", "Διαθέσιμο Υπόλοιπο"}, 0) { 
        ...
        JLabel l2 = new JLabel("Οι τελευταίες συναλλαγές μου"); 
        l2.setFont(new Font("Segoe UI", Font.BOLD, 18));
        p2.add(l2, BorderLayout.NORTH);
        
        trxModel = new DefaultTableModel(new String[]{"Είδος", "Από", "Προς", "Ποσό", "Αιτιολογία", "Ημερομηνία", "Προμήθεια", "Υπόλοιπο"}, 0) { 
            @Override public boolean isCellEditable(int r, int c) { return false; } 
        };
        JTable trxTable = new JTable(trxModel); 
        trxTable.setRowHeight(30);
    ...
    // Η μέθοδος που καλείται ΑΥΤΟΜΑΤΑ από το Account όταν αλλάξει το υπόλοιπο
    @Override
    ...
    public void refresh() {
        ...
        // Ταξινόμηση και εμφάνιση Transaction
